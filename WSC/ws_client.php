<?php
    ...
    if (isset($_GET["pays"]))
    {
		...
		if(!$error){
			...
			$err = $client->getError();
			if ($err) {
				echo '<h1>Constructor error</h1>' . $err;
...
<div class="container">
  <h1 style="color:red">Books Store SOAP Web Service</h1>
  ...
  <div class='row'>
   ...
   <br />
   <h2 style="color:#0000FF">PAYS Information</h2>
  <table class="table">
    <thead>
	<?php if (isset($rs))
	{ ?>
	...
	<div class='row'>
	<h2 style="color:#0000FF">Add New PAYS</h2>
